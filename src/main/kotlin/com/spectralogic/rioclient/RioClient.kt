...
class RioClient(
    ...
    suspend fun deleteApiToken(id: UUID): EmptyResponse = client.myDelete("$api/keys/$id")

    suspend fun getApiToken(id: UUID): TokenKeyResponse = client.myGet("$api/keys/$id")

    suspend fun headApiToken(id: UUID): Boolean = client.myHead("$api/keys/$id")

    suspend fun listTokenKeys(
        page: Long? = null,
        perPage: Long? = null,
    ): TokenListResponse = client.myGet("$api/keys", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun deleteDevice(
        type: String,
        name: String,
    ): EmptyResponse = client.myDelete("$api/devices/$type/$name")

    suspend fun headDevice(
        type: String,
        name: String,
    ...
    suspend fun updateSpectraDevice(
        name: String,
        spectraDeviceUpdateRequest: SpectraDeviceUpdateRequest,
    ): SpectraDeviceResponse = client.myPut("$api/devices/spectra/$name", spectraDeviceUpdateRequest)

    suspend fun deleteSpectraDevice(name: String): EmptyResponse = client.myDelete("$api/devices/spectra/$name")

    suspend fun getSpectraDevice(name: String): SpectraDeviceResponse = client.myGet("$api/devices/spectra/$name")

    suspend fun headSpectraDevice(name: String): Boolean = client.myHead("$api/devices/spectra/$name")

    suspend fun listSpectraDevices(
        page: Long? = null,
        perPage: Long? = null,
    ...
    suspend fun updateDivaDevice(
        name: String,
        divaDeviceUpdateRequest: DivaDeviceUpdateRequest,
    ): DivaDeviceResponse = client.myPut("$api/devices/diva/$name", divaDeviceUpdateRequest)

    suspend fun deleteDivaDevice(name: String): EmptyResponse = client.myDelete("$api/devices/diva/$name")

    suspend fun getDivaDevice(name: String): DivaDeviceResponse = client.myGet("$api/devices/diva/$name")

    suspend fun headDivaDevice(name: String): Boolean = client.myHead("$api/devices/diva/$name")

    suspend fun listDivaDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): DivaDeviceListResponse = client.myGet("$api/devices/diva", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun updateFlashnetDevice(
        name: String,
        flashnetDeviceUpdateRequest: FlashnetDeviceUpdateRequest,
    ): FlashnetDeviceResponse = client.myPut("$api/devices/flashnet/$name", flashnetDeviceUpdateRequest)

    suspend fun deleteFlashnetDevice(name: String): EmptyResponse = client.myDelete("$api/devices/flashnet/$name")

    suspend fun getFlashnetDevice(name: String): FlashnetDeviceResponse = client.myGet("$api/devices/flashnet/$name")

    suspend fun headFlashnetDevice(name: String): Boolean = client.myHead("$api/devices/flashnet/$name")

    suspend fun listFlashnetDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): FlashnetDeviceListResponse = client.myGet("$api/devices/flashnet", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun updateS3cDevice(
        name: String,
        s3cDeviceUpdateRequest: S3CDeviceUpdateRequest,
    ): S3CDeviceResponse = client.myPut("$api/devices/s3c/$name", s3cDeviceUpdateRequest)

    suspend fun deleteS3cDevice(name: String): EmptyResponse = client.myDelete("$api/devices/s3c/$name")

    suspend fun getS3cDevice(name: String): S3CDeviceResponse = client.myGet("$api/devices/s3c/$name")

    suspend fun headS3cDevice(name: String): Boolean = client.myHead("$api/devices/s3c/$name")

    suspend fun listS3cDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): S3CDeviceListResponse = client.myGet("$api/devices/s3c", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun updateTbpfrDevice(
        name: String,
        tbpfrDeviceUpdateRequest: TbpfrDeviceUpdateRequest,
    ): TbpfrDeviceResponse = client.myPut("$api/devices/tbpfr/$name", tbpfrDeviceUpdateRequest)

    suspend fun deleteTbpfrDevice(name: String): EmptyResponse = client.myDelete("$api/devices/tbpfr/$name")

    suspend fun getTbpfrDevice(name: String): TbpfrDeviceResponse = client.myGet("$api/devices/tbpfr/$name")

    suspend fun headTbpfrDevice(name: String): Boolean = client.myHead("$api/devices/tbpfr/$name")

    suspend fun listTbpfrDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): TbpfrDeviceListResponse = client.myGet("$api/devices/tbpfr", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun updateVailDevice(
        name: String,
        vailDeviceUpdateRequest: VailDeviceUpdateRequest,
    ): VailDeviceResponse = client.myPut("$api/devices/vail/$name", vailDeviceUpdateRequest)

    suspend fun deleteVailDevice(name: String): EmptyResponse = client.myDelete("$api/devices/vail/$name")

    suspend fun getVailDevice(name: String): VailDeviceResponse = client.myGet("$api/devices/vail/$name")

    suspend fun headVailDevice(name: String): Boolean = client.myHead("$api/devices/vail/$name")

    suspend fun listVailDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): VailDeviceListResponse = client.myGet("$api/devices/vail", paramMap = pageParamMap(page, perPage))

    /**
     * Endpoint
     */
    suspend fun deleteEndpointDevice(name: String): EmptyResponse = client.myDelete("$api/devices/endpoint/$name")

    suspend fun getEndpointDevice(name: String): EndpointGenericDeviceResponse = client.myGet("$api/devices/endpoint/$name")

    suspend fun headEndpointDevice(name: String): Boolean = client.myHead("$api/devices/endpoint/$name")

    suspend fun listEndpointDevices(
        page: Long? = null,
        perPage: Long? = null,
    ): EndpointDeviceListResponse = client.myGet("$api/devices/endpoint", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun getFtpEndpointDevice(name: String): EndpointFtpDeviceResponse = client.myGet("$api/devices/endpoint/$name")
    ...
    suspend fun getS3EndpointDevice(name: String): EndpointS3DeviceResponse = client.myGet("$api/devices/endpoint/$name")
    ...
    suspend fun getUriEndpointDevice(name: String): EndpointUriDeviceResponse = client.myGet("$api/devices/endpoint/$name")
    ...
    suspend fun deleteBroker(
        brokerName: String,
        force: Boolean,
    ): EmptyResponse = client.myDelete("$api/brokers/$brokerName?force=$force")

    suspend fun getBroker(brokerName: String): BrokerResponse = client.myGet("$api/brokers/$brokerName")

    suspend fun headBroker(brokerName: String): Boolean = client.myHead("$api/brokers/$brokerName")
    ...
    suspend fun listAgents(
        ...
        page: Long? = null,
        perPage: Long? = null,
    ): AgentListResponse = client.myGet("$api/brokers/$brokerName/agents", paramMap = pageParamMap(page, perPage))

    suspend fun createAgent(
        brokerName: String,
        agentCreateRequest: AgentCreateRequest,
    ): AgentResponse = client.myPost("$api/brokers/$brokerName/agents", agentCreateRequest)

    suspend fun updateAgent(
        brokerName: String,
        agentName: String,
        agentUpdateRequest: AgentUpdateRequest,
    ): AgentResponse = client.myPut("$api/brokers/$brokerName/agents/$agentName", agentUpdateRequest)

    suspend fun deleteAgent(
        brokerName: String,
        agentName: String,
        force: Boolean?,
    ): EmptyResponse = client.myDelete("$api/brokers/$brokerName/agents/$agentName", "force", force)

    suspend fun getAgent(
        brokerName: String,
        agentName: String,
        includeIndexState: Boolean? = null,
    ): AgentResponse = client.myGet("$api/brokers/$brokerName/agents/$agentName", "includeIndexState", includeIndexState)

    suspend fun headAgent(
        brokerName: String,
        agentName: String,
    ...
    suspend fun objectExists(
        brokerName: String,
        objectName: String,
    ): Boolean = client.myHead("$api/brokers/$brokerName/objects/${objectName.urlEncode()}")
    ...
    suspend fun updateObject(
        ...
        internalData: Boolean? = null,
        merge: Boolean = false,
    ): ObjectResponse {
        val paraMap: Map<String, Any?> =
            mapOf(
    ...
    suspend fun updateObjects(
        brokerName: String,
        updateRequest: ObjectBatchUpdateRequest,
        internalData: Boolean? = null,
        merge: Boolean = false,
    ): EmptyResponse {
        val paraMap: Map<String, Any?> =
    ...
    suspend fun retryArchiveJob(
        brokerName: String,
        retry: UUID,
    ): JobResponse = client.myPost("$api/brokers/$brokerName/archive?retry=$retry")
    ...
    ): DetailedJobResponse = client.myGet("$api/jobs/$jobId", "withFileStatus", withFileStatus)
    ...
    suspend fun deleteJob(jobId: UUID): EmptyResponse = client.myDelete("$api/jobs/$jobId")

    suspend fun deleteAllJobs(): EmptyResponse = client.myDelete("$api/jobs")

    suspend fun cancelJob(jobId: UUID): EmptyResponse = client.myPut("$api/jobs/$jobId?cancel=true")

    suspend fun headJob(jobId: String): Boolean = client.myHead("$api/jobs/$jobId")
    ...
    suspend fun fileStatus(jobId: UUID): FileStatusLogResponse = client.myGet("$api/jobs/$jobId/filestatus")

    suspend fun fileStatus(
        jobId: UUID,
        objectName: String,
     ...
     * Log
     */
    suspend fun createLogset(): LogsetResponse = client.myPost("$api/logs")
    ...
    suspend fun headLogset(logsetId: UUID): Boolean = client.myHead("$api/logs/$logsetId")

    suspend fun listLogsets(
        page: Long? = null,
        perPage: Long? = null,
    ): LogsetListResponse = client.myGet("$api/logs", paramMap = pageParamMap(page, perPage))

    suspend fun getLogLevel(): LogLevelResponse = client.myGet("$api/logs/root/level")

    suspend fun setLogLevel(logLevel: String): LogLevelSetResponse = client.myPut("$api/logs/root/level/$logLevel")

    /**
     * Messages
     */
    suspend fun getMessage(messageId: UUID): MessageResponse = client.myGet("$api/messages/$messageId")

    suspend fun listMessages(
        page: Long? = null,
        perPage: Long? = null,
    ): MessageListResponse = client.myGet("$api/messages", paramMap = pageParamMap(page, perPage))
    ...
    suspend fun updateAllMessage(read: Boolean) = client.myPatch("$api/messages", MessageUpdateRequest(read))

    /**
     * System
     */
    suspend fun systemInfo(): SystemResponse = client.myGet("$api/system")
    ...
    suspend fun clientDataUpdate(
        dataId: UUID,
        clientDataRequest: ClientDataRequest,
    ): ClientDataResponse = client.myPut("$api/system/clientData/$dataId", clientDataRequest)

    suspend fun clientDataDelete(dataId: UUID): EmptyResponse = client.myDelete("$api/system/clientData/$dataId")
    ...
    suspend fun clientDataGet(dataId: UUID): ClientDataResponse = client.myGet("$api/system/clientData/$dataId")
    ...
    suspend fun saveRioClient(
        ...
        val request: RioClientApplicationRequest =
            try {
    ...
    suspend fun listRioClientApplications(): RioClientApplicationsListResponse = client.myGet("$api/system/rioclient/applications")
    ...
    private fun paramMap(
        key: String,
        value: Any? = null,
    ): Map<String, Any?>? = value?.let { mapOf<String, Any?>(Pair(key, value)) }

    private fun pageParamMap(
        page: Long? = null,
        perPage: Long? = null,
    ): Map<String, Any?> = mapOf(Pair("page", page), Pair("per_page", perPage))

    private suspend inline fun <reified T : RioResponse> HttpClient.myDelete(
        url: String,
        key: String,
        value: Any? = null,
    ): T = myDelete(url, paramMap(key, value))
    ...
    private suspend inline fun <reified T : RioResponse> HttpClient.myGet(
        ...
        key: String,
        value: Any? = null,
    ): T = myGet(url, paramMap = paramMap(key, value))
    ...
    private suspend inline fun <reified T : RioResponse> HttpClient.myPost(
        ...
        key: String,
        value: Any? = null,
    ): T = myPost(url, request, paramMap(key, value))
    ...
    private suspend inline fun <reified T : RioResponse> HttpClient.myPut(
        url: String,
        request: RioRequest? = null,
        paramMap: Map<String, Any?>? = null,
    ): T {
    ...
    private suspend inline fun <reified T : RioResponse> HttpResponse.myGetBody(
    ...
    suspend fun metadataValues(
        brokerName: String,
        metadataKey: String,
        page: Long = 0,
        perPage: Long = 100,
        internal: Boolean,
    ): ListMetadataValuesDistinct {
...
data class ListMetadataValuesDistinct(
    ...
    RioListResponse<Map<String, String>> {
